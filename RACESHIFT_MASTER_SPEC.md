...
- 41 passing Python tests (leakage and feature-availability, lap-state adjacency, chronological and round splits, Forward-Forward policy, artifact forecasting, local API)
